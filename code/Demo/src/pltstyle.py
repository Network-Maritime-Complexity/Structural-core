...
Usage: Customized plot styles

Methods:
    * anno_style(): annotate style, red dash line and black solid line.
    * get_linestyles(): line style, solid line, dotted line or dashed line and so on.
    * axes_style(): axes style, including tick style and spine style
