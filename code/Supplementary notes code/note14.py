...
class LFCConnection:
    ...
    def core_connections_importance(self):
        ...
        print()
        print('"First, core connections themselves tend to be longer than feeder and local connections (Fig. 24b). '
        ...
        if SAVE_RESULT:
            save_path = os.path.join('output', 'Supplementary note 14')
            if os.path.exists(save_path):
                pass
            else:
                os.makedirs(save_path)
            filename = 'Fig. 24 Statistics of the core feeder and local connections (b).xlsx'
    ...
    def pr_lfc(edges):
        ...
        if SAVE_RESULT:
            ...
            if os.path.exists(save_path):
                ...
                os.makedirs(save_path)
            filename = 'Fig. 24 Statistics of the core feeder and local connections (c).xlsx'
...
def startup():
    ...
    print('Section titled "Supplementary note 14: Significant importance of core connections in supporting '
