...
def plot_k_rc(df_nodes):
    ...
    plt.tight_layout()
    if SAVE_RESULT:
        save_path = os.path.join('output', 'Supplementary note 10')
        if os.path.exists(save_path):
            pass
        else:
            os.makedirs(save_path)
        filename = 'Supplementary Fig. 13 Rich-club coefficients of world ports.png'
...
def startup():
    ...
    print('Section titled "Supplementary note 10: Rich-club coefficients of world ports"')
    print('*********************************')
    print()
