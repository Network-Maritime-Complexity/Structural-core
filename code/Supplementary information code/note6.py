...
def plot_result(data, coor_xs, coor_ys, pp):
    ...
    if SAVE_RESULT:
        ...
        if param == 'B_sub':
            filename = 'Supplementary Fig. 11 Results for the structural-core...submodular gateway hubs (a).png'
        elif param == 'Z_sub':
            filename = 'Supplementary Fig. 12 Results for the structural-core...submodular provincial hubs (a).png'
        else:
            filename = 'Supplementary Fig. 13 Results for the structural-core...submodular connector hubs (a).png'
...
def calculate_density(param, num_scs):
    ...
    x = [1, 2, 3, 4, 5, 6]
    ax.plot(x, list(empirical_den.values()), 'rX', ms=12)
    ...
    if SAVE_RESULT:
        ...
        if os.path.exists(save_path):
            ...
            os.makedirs(save_path)
        filename = 'Supplementary Fig. 14 Comparison with permutated networks for the connectivity ' \
                   'density...modules.png'
...
def startup():
    if os.path.exists(data_path):
        ...
        print('Section titled "Supplementary note 6: Gateway-hub structural core organization of the GLSN at modular level"')
        print('*********************************')
        print()
            ...
            if pp[0] == 'B_sub':
                ...
                if SAVE_RESULT:
                    ...
                    if os.path.exists(save_path):
                        ...
                        os.makedirs(save_path)
                    filename = 'Supplementary Table 4 Summary of data...topological centrality of structural-' \
                               'core...modules.csv'
