...
data_path = os.path.join('../data', 'note9')
...
def plot_sc_freq(data, year):
    ...
    if SAVE_RESULT:
        save_path = os.path.join('output', 'Supplementary note 9')
        if os.path.exists(save_path):
            pass
        else:
            os.makedirs(save_path)
        if year == '2015':
            filename = 'Supplementary Fig. 17 Frequency...across datasets-(a) GLSN of 2015.png'
        else:
            filename = 'Supplementary Fig. 17 Frequency...across datasets-(b) GLSN of 2017.png'
...
def plot_hist(tv_mean, tv_se, btv_mean, btv_se, year):
    ...
    if SAVE_RESULT:
        ...
        if os.path.exists(save_path):
            ...
            os.makedirs(save_path)
        if year == '2015':
            filename = 'Supplementary Fig. 18 Pearson correlation coefficients...' \
...
def startup():
    ...
    if os.path.exists(data_path):
        ...
        print('Section titled "Supplementary note 9: Robustness of the structural-core organization of '
