...
data_path = os.path.join('../data', 'note5')
...
def sc_robustness():
    ...
    if SAVE_RESULT:
        ...
        filename = 'Supplementary Table 2 Pearson correlation coefficients....xlsx'
...
def plot_sc_freq(data):
    ...
    if SAVE_RESULT:
        ...
        if os.path.exists(save_path):
            ...
            os.makedirs(save_path)
        filename = 'Supplementary Fig. 8 Frequency with which a structural core was ' \
...
def plot_hist(df_country_pr, df_country_pair_pr):
    ...
    if SAVE_RESULT:
        ...
        if os.path.exists(save_path):
            ...
            os.makedirs(save_path)
        filename = 'Supplementary Fig. 9 Pearson correlation coefficients...averaged over {} repetitions ' \
...
def startup():
    ...
    if os.path.exists(data_path):
        ...
        print('Section titled "Supplementary note 5: Robustness of empirical findings on the structural-core '
              'organization of the GLSN to the non-detrimental property of the Louvain algorithm in community division"')
        print('*********************************')
        print()
